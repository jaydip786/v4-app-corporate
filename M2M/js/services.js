...
app.value('urlService', {
    apiCallsUrl: "http://180.211.100.130:8081/v4-phonegap-app/index.php/API/",
    imagesUrl: "http://180.211.100.130:8081/v4-phonegap-app/assets/frontend/images/"
});

//options lists

app.value('constantsService', {
...
app.factory('networkService', function( $http, $q, $log, urlService, stateService){
